...
sampleReader.o: sampleReader.cpp sampleReader.h 
	$(CXX) $(CFLAGS) -c sampleReader.cpp  
sampleMerger.o: sampleMerger.cpp sampleMerger.h 
...
agg_utils.o: agg_utils.cpp agg.h 
	$(CXX) $(CFLAGS) -c $< 
agg_collate.o: agg_collate.cpp agg.h 
	$(CXX) $(CFLAGS) -c $<  
agg_genotype.o: agg_genotype.cpp agg.h 
	$(CXX) $(CFLAGS) -c $<  
agg_count.o: agg_count.cpp agg.h 
	$(CXX) $(CFLAGS) -c $<  
agg_update.o: agg_update.cpp agg.h 
	$(CXX) $(CFLAGS) -c $<  

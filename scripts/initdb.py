...
if __name__ == "__main__":
    ...
    for i in xrange(0,len(gvcfs),args.nprocess):
        ...
        if args.batch=="qsub":
            ...
            qsub = ["sbatch","--time=1:00:00","--parsable",scripts+"ingest_multi_gvcf.py"]
    ...
    if args.batch=="qsub":        
        ...
        cmd = ["sbatch","--time=2:00:00","-d",hold,"--parsable",scripts+"multi_collate.py",db_dir,"-agg",args.agg+"/","-nprocess",str(args.nprocess)]
    print " ".join(cmd)
